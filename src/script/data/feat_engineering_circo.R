...
feat_engineering_circo <- function(data, cols_to_keep, candidates){
  
  cat("[circo] Computing feature engineering... \n")
  ...
  data$codgeo <- paste0(data$Code.du.département, str_pad(data$Code.de.la.circonscription, 3, pad = "0"))
  ...
  ouput <- data %>%
    ...
    summarise(Nb.b.vote = n(),
              ...
              Code.de.la.circonscription = unique(Code.de.la.circonscription)) %>% 
